...
export function getMockSupportGroups(): SupportGroup[] {
  return [
    {
      id: 'group-parents',
      name: 'Parents of Adult Children',
      icon: '👨‍👩‍👦',
      accentColor: '#fdf3e3',
      onlineCount: 14,
      nextSessionAt: null,
      scheduleLabel: 'Session tonight 7 PM',
    ...
    {
      id: 'group-90days',
      name: 'First 90 Days After Intervention',
      icon: '🧭',
      accentColor: '#e9f2ec',
      onlineCount: 8,
      nextSessionAt: null,
      scheduleLabel: 'Drop-in anytime',
    ...
    {
      id: 'group-spouses',
      name: 'Spouses & Partners Circle',
      icon: '💞',
      accentColor: '#fbeae7',
      onlineCount: 0,
      nextSessionAt: null,
      scheduleLabel: 'Weekly · Thursdays 8 PM',
      scheduleType: 'recurring',
      joinUrl: null,
      requiresPremium: false,
    },
