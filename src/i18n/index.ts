...
export async function initI18n(): Promise<void> {
  ...
  await i18n.use(initReactI18next).init({
    resources: {
      en: { common: enCommon, today: enToday, scripts: enScripts, boundaries: enBoundaries, auth: enAuth, tracker: enTracker, support: enSupport, settings: enSettings, alignment: enAlignment, letter: enLetter, rehearsal: enRehearsal },
      es: { common: esCommon, today: esToday, scripts: esScripts, boundaries: esBoundaries, auth: esAuth, tracker: esTracker, support: esSupport, settings: esSettings, alignment: esAlignment, letter: esLetter, rehearsal: esRehearsal },
    },
    lng,
    fallbackLng: 'en',
    ns: ['common', 'today', 'scripts', 'boundaries', 'auth', 'tracker', 'support', 'settings', 'alignment', 'letter', 'rehearsal'],
    defaultNS: 'common',
